# Generated by Django 6.0.2 on 2026-05-07 16:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_category', models.CharField(max_length=100, verbose_name='Категория товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_scent', models.CharField(max_length=100, verbose_name='Название аромата')),
                ('notes', models.TextField(blank=True, verbose_name='Описание нот')),
            ],
            options={
                'verbose_name': 'Аромат',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product', to='main.scent', verbose_name='Аромат')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_client', models.CharField(max_length=50, verbose_name='Имя заказчика')),
                ('contact_info', models.CharField(max_length=100, verbose_name='Контакты заказчика')),
                ('status', models.CharField(choices=[('new', 'новый'), ('in_progress', 'делается'), ('done', 'готово')], max_length=20, verbose_name='Статус заказа')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Дата и время подачи заявки')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leads', to='main.product', verbose_name='Название товара для заказа')),
            ],
            options={
                'verbose_name': 'Заявка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='products/%Y/%m/%d/', verbose_name='Фото товара')),
                ('main_img', models.BooleanField(blank=True, verbose_name='Главное фото')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product', to='main.product', verbose_name='Товара')),
            ],
        ),
    ]
